		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<div class="muted pull-right"><a id="return" data-placement="left" title="Click to Return" href="device_location.php"><i class="icon-arrow-left icon-large"></i> Back</a></div>
																<script type="text/javascript">
																$(document).ready(function(){
																	$('#return').tooltip('show');
																	$('#return').tooltip('hide');
										...
										<div class="row-fluid">
											<div class="empty">
												<div class="pull-right">
													<a href="print_barcode.php?id=<?php echo $row['id']; ?>" class="btn btn-info" id="print" data-placement="left" title="Click To Print">
