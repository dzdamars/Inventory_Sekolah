...
mysql_query("insert into stdevice (dev_id,dev_desc,dev_serial,dev_model,dev_status,nomor_urut,tahun,qty,dev_sumber) values('$dev_id','$dev_desc','$dev_serial','$dev_model','$dev_status','$nomor_urut','$tahun','$qty','$dev_sumber')")or die(mysql_error());
