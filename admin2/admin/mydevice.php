...
<tr>
		<td><?php
			...
			<td class="empty"><a rel="tooltip"  title="Transfer Device" id="e<?php echo $id; ?>" href="transfer.php<?php echo '?id='.$id; ?>&<?php echo 'stdev_id='.$get_id; ?>" class="btn btn-warning"><i class="icon-move"></i> Move </a>
			<?php include('toolttip_edit_delete.php'); ?>												
			<td class="empty" width="80">
			<a rel="tooltip" title="Detail Device" id="e<?php echo $id; ?>" href="device_detail_loc.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"> Detail</i></a></td>
