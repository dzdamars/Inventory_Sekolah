		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<div class="muted pull-right"><a id="return" data-placement="left" title="Click to Return" href="device_habispakai.php"><i class="icon-arrow-left icon-large"></i> Back</a></div>
																<script type="text/javascript">
																$(document).ready(function(){
																	$('#return').tooltip('show');
																	$('#return').tooltip('hide');
...
<br>
										...
										<div class="row-fluid">
											<div class="empty">
												<div class="pull-right">
													<a href="print_barcode_hb.php?id=<?php echo $row['id']; ?>" class="btn btn-info" id="print" data-placement="left" title="Click To Print">
														<i class="icon-print icon-large"></i> Print Barcode</a>
														<script type="text/javascript">
																$(document).ready(function(){
																	$('#return').tooltip('show');
																	$('#return').tooltip('hide');
		                            ...
		                            <div class="block-content collapse in">									
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_id']; ?>" name="dev_serial" id="inputPassword" placeholder="Device Serial Number"readonly required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['qtyu']; ?>" name="dev_model" id="inputPassword" placeholder="Device Model" readonly required>
											</div>
										</div>
