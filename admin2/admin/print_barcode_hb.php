...
<?php
    ...
    LEFT JOIN habis_pakai ON st_barang.dev_id=habis_pakai.dev_id WHERE id = $_GET[id]")or die(mysql_error());
...
"Times New Roman","serif"'>Cetak Barcode<o:p></o:p></span></p>
<p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
"Times New Roman","serif"'>Inventaris : <o:p><?php echo $row['dev_name_hb']?></o:p></span></p>

<p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
"Times New Roman","serif"'>Inventaris Desc: <o:p><?php echo $row['dev_desc']?></o:p></span></p>
...
<div class="pull-right">
   <div class="empty">
           ...
           normal'><span style='font-size:17.0pt;mso-bidi-font-size:17.0pt;font-family:
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <p class=MsoNormal align="center" style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-family:"Times New Roman","serifd"'><?php
                                       
                                                include"barcode/BarcodeGenerator.php";
                                                include "barcode/BarcodeGeneratorPNG.php";
                                                $generator = new BarcodeGeneratorPNG();
                                                echo '<img style="max-width:550px"src="data:image/png;base64,' . base64_encode($generator->getBarcode($row['dev_serial'], $generator::TYPE_CODE_128)) . '"><br>';
                                       ?></span></p>  
