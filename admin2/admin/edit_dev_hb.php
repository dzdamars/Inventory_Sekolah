    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_dev_hb_form.php'); ?>		   			
				</div>
				<?php	
								...
								<form action="delete_client.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="75">
												<a rel="tooltip"  title="Edit Client" id="e<?php echo $id; ?>" href="edit_dev_hb.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit</i></a>
												</td>
