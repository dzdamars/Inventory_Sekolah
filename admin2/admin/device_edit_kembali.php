...
<br>
									...
									<form class="form-horizontal" method="POST" action="kembali.php?nomor_pinjam=<?php echo $get_id; ?>" >	
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['mulai']; ?>" name="dev_model" id="inputPassword" placeholder="Device Model" readonly required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['sampai']; ?>" name="dev_model" id="inputPassword" placeholder="Device Model" readonly required>
											</div>
										</div>
