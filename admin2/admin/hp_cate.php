    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_dev_name=mysql_query("select * from habis_pakai");
                 ...
                 ?>	 
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<form action="delete_hp_cate.php" method="post">
									...
									<?php include('modal_delete_hb.php'); ?>
										<thead>
										  <tr>
												<th></th>
												<th>Device Name</th>										
										...
										<tbody>
													<?php
													$device_name_query = mysql_query("select * from habis_pakai")or die(mysql_error());
												...
												<td><?php echo $row['dev_name_hb']; ?></td>
												
											    <?php include('toolttip_edit_delete.php'); ?>															
												<td width="75">
												<a rel="tooltip"  title="Edit Device Name" id="e<?php echo $id; ?>" href="edit_dev_hb.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit</i></a>
												</td>
