...
$query = mysql_query("select * from habis_pakai where dev_name_hb = '$dev_name'")or die(mysql_error());
$count = mysql_num_rows($query);

if ($count > 0){ ?>
<script>
alert('Device Name Already Exist');
</script>
<?php
}else{

mysql_query("insert into habis_pakai (dev_name_hb) values('$dev_name')")or die(mysql_error());
