...
<html class="no-js">
    <head>
        <title>SMKN 1 CIBINONG</title>	
        <meta name="description" content="Smkn 1 Cibinong">
		<meta name="author" content="Lawflase">
		<meta charset="UTF-8">
		
        <!-- Bootstrap -->
				<link href="images/kamvak.png" rel="icon" type="image">
