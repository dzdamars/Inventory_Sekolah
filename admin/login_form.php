			...
			<form class="form-signin" method="post" action="register.php">
				<button data-placement="right" title="Click Here to Register" id="register" name="login" class="btn btn-info" type="submit"><i class="icon-signin icon-large"></i> Create Account</button>
				...
				$('#register').tooltip('hide');
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to Smkn 1 Cibinong (Kamvak)", { header: 'Access Granted' });
									var delay = 1000;
