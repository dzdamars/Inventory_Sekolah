		                                 ...
		                                 <label class="control-label" for="inputEmail">Nama Barang</label>
			                                <div class="controls">
				                              <select name="dev_id" class="chzn-select"  required/>
												 ...
												 ?>
				                                 <option value="<?php echo $row['dev_id']; ?>&nbspName&nbsp<?php echo $row['dev_name_hb']; ?>"><?php echo $row['dev_name_hb']; ?></option>
				                                 <?php } ?>
				                               </select>
		                                     </div>
	                                    </div>
...
mysql_query("insert into st_barang (dev_id,dev_desc,dev_serial,dev_model,dev_status,nomor_urut,tahun,qty,dev_sumber) values('$dev_id','$dev_desc','$dev_serial','$dev_model','$dev_status','$nomor_urut','$tahun','$qty','$dev_sumber')")or die(mysql_error());
