		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
										...
										<div class="muted pull-right"><a id="return" data-placement="left" title="Click to Return" href="mydevice2.php"><i class="icon-arrow-left icon-large"></i> Back</a></div>
																<script type="text/javascript">
																$(document).ready(function(){
																	$('#return').tooltip('show');
																	$('#return').tooltip('hide');
...
<br>
		                            ...
		                            <div class="block-content collapse in">									
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" value="<?php echo $row['dev_name_hb']; ?>" name="dev_serial" id="inputPassword" placeholder="Device Serial Number"readonly required>
											</div>
										</div>
